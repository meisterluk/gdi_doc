...
\lstset{language={Haskell},label={lst:fib},caption={Haskell Quelltext zur Definition der Fibonacci-Zahlen}}
\begin{lstlisting}
fib 0 = 0
fib 1 = 1
...
%
\lstset{language={C},label={lst:fibc},caption={C Quelltext zur Definition der Fibonacci-Zahlen}}
\begin{lstlisting}
#include <stdio.h>
