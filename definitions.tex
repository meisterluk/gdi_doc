...
%\case{{german}}%
  ...
  \newcommand{\courseics}{,,Einführung in das Studium der Informatik`` (710.104, nur Informatikstudium)}%
  \newcommand{\coursesee}{,,Einführung in Softwareentwicklung-Wirtschaft`` (710.010, nur SEW-Studium)}%
  \newcommand{\courseisp}{,,Einführung in die strukturierte Programmierung`` (706.001)}%
  \newcommand{\coursedm}{,,Diskrete Mathematik`` (503.007)}%
  \newcommand{\coursellp}{,,Logik und Logische Programmierung`` (716.051, nur Informatikstudium)}%
  ...
  \newcommand{\coursetcs}{,,Theoretische Informatik 1`` (708.243, nur Informatikstudium)}%
  \newcommand{\courselc}{,,Logik und Berechenbarkeit`` (705.033, nur Informatikstudium)}%
...
%\case{{english}}%
  ...
  \newcommand{\courseics}{``Introduction to Computer Science'' (710.104, only CS studies)}%
  \newcommand{\coursesee}{``Software Engineering and Economy'' (710.010, only SDBM studies)}%
  ...
  \newcommand{\coursellp}{``Logic and Logic Programming'' (716.051, only CS studies)}%
  ...
  \newcommand{\coursetcs}{``Theoretical Computer Science I'' (708.243, only CS studies)}%
  \newcommand{\courselc}{``Logic and Computability'' (705.033, only CS studies)}%
