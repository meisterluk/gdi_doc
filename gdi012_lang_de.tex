...
\lstset{language={}, label={lst:regex_repetition}, caption={Die Grammatik $R$ als regulärer Ausdruck}, frame={single}}
\begin{lstlisting}
a?bc*
\end{lstlisting}
...
Als ersten Schritt (um $R$ zu definieren) beschreiben wir eine Grammatik $R1$ mit ,Das Zeichen \gramm{a} kann vorkommen`.
...
\index{Kontextfreie Grammatik!Beispiel}
...
\index{Kontext-sensitive Grammatik}
%
...
\index{Kontext-sensitive Grammatik!Beispiel}
