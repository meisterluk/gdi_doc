...
\lstset{language={}, caption={Die Grammatik $\{a^n b c^m | 0\leq n\leq 1, m \geq 0\}$}, frame={single}}
\begin{lstlisting}
a?bc*
\end{lstlisting}
...
\lstset{language={}, caption={Die Message-Grammatik}, frame={single}}
\begin{lstlisting}
...
\lstset{language={}, caption={Anzahl von ,,a`` gleich Anzahl von ,,b``}, frame={single}}
\begin{lstlisting}
(ab)*
\end{lstlisting}
...
\lstset{language={}, caption={,,a`` gefolgt von ,,b''}, frame={single}}
\begin{lstlisting}
a*b*
\end{lstlisting}
...
\lstset{language={}, caption={Die kontext-freie Grammatik $\set{a^n b^n}$}, escapechar={}, frame={single}}
\begin{lstlisting}
S ::= aSb | $
\end{lstlisting}

Basierend auf S können wir jetzt beliebige Wörter der Sprache ableiten
\lstset{language={}, caption={Die Ableitung von ,,aaabbb``}, frame={single}}
\begin{lstlisting}
S
aSb
aaSbb
...
\lstset{language={}, caption={Die kontext-freie Grammatik für ein kontext-sensitives Problem}, frame={single}}
\begin{lstlisting}
S ::= aSbB | $
B ::= Bc
\end{lstlisting}
...
\lstset{language={}, caption={Die kontext-freie Grammatik $\set{a^n b^n c^n}$}, frame={single}}
\begin{lstlisting}
S ::= aSBH | $
aS ::= aa
aB ::= ab
